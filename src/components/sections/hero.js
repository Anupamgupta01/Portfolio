...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Anupam Gupta</h2>;
  const three = <h3 className="big-heading">I build things on web.</h3>;
  const four = (
    <>
      <p>
  ...
  const five = (
    <a
      ...
      href="https://www.linkedin.com/in/anupam-gupta-443387195/"
      target="_blank"
      rel="noreferrer">
      Get in touch
    </a>
